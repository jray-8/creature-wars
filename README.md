...
- Each player controls an Empire with __42 HP__.

	- There is no max HP.

- Whoever loses all their HP first loses.

	- If the deck is empty before a player has won, go to [_MAYHEM!_](#mayhem)
...
- __Max hand size 10__

	- Cards drawn beyond 10 are discarded.
...
Because Witch effects can be unpredictable—and sometimes harmful—playing a Witch card is often a gamble. The same Witch may save your Empire with one hand and doom it with another. So hold onto your Witch cards and use them wisely!
...
| Barmbrack Witch | Restore 2 HP to your Empire and find a charm: <br>Ring - Choose a creature in your hand; get a random Tribe mate. <br>Coin - Give your hand `+1 levels`. <br>The Matchstick - Your hand loses `3 levels`. |
...
| Sun King's Witch | Shuffle `Nightmare` and Witch cards in each player's hand back into the deck. `Fire` creatures in both hands get `+3 levels`, but explode in 2 turns if left unplayed, dealing their `base str` to the holder's Empire. |
...
| Dark Globe Witch | Creatures in both hands lose their Tribe and Power Type for the rest of the game. |
...
| Clockwork Crier Witch | Set a prophecy: choose a number (1-3). After that many turns, draw that many cards and take 2 damage for each drawn. |
| Crow-Laughing Witch | Whenever a witch escapes, give a creature in the opponent's hand `-2 levels`. |
| Daisy-Chain Witch | Cast the effects of all other Witch cards in your hand. You choose the order. They all flee afterwards, and each draws you a card. |
...
| Randall's Witch | The next Empire to play a Witch takes 2 damage. |
...
| Indignified Witch | _Humiliate_: If this Witch wins the duel, the opposing creature permanently loses its Power Type, Tribe, and `2 levels`. |
...
| Nude Witch | Reveal both hands. Discard all level 1 cards exposed. |
| Racist Witch | _The Unspeakable_: Declare one of the 7 Tribes as uncouth. Whenever such a creature is played, the commanding Empire takes 2 damage. |
| Death Witch | Choose to exploit the opponent's Empire or your own. A random creature in the target's hand has its base str increased by 5 but deals double damage. |
| Nizari Witch | The first witch to be played while this is in your hand has its effect nullified. Whenever that happens, discard this Witch. |
| Witch of Absolution | Erase all active Witch effects and curses. |
...
| The Ouroboros Witch | Transform _ALL_ Serpents into random Dragons, and _ALL_ Dragons into random Serpents. |
...
| The Great Imitator | While in hand: The next card your opponent draws is secretly transformed into The Great Imitator, but theirs is fake. If the Fake Imitator is played, a random card in hand is Paralyzed. If the Real Imitator is played, reveal your opponent's entire hand and steal the "Fake" card back; it becomes a random Sinful Witch in your hand. If the Fake Imitator is not present, restore 12 HP to your Empire instead. |
...
| Witchatter, The Mad | Both players discard their hand and redraw the same number of cards. Randomly assign cooldown 0-3 to each. |
| Witchatter, The Mad | _Perpetual Tea-Time_: Both players discard their hand and draw 6 new cards. <br>Players no longer draw cards at the start of each turn. <br>Instead, when a player's hand is empty, they draw 6 new cards from the deck. <br>Mayhem occurs when a player's hand is empty and there are no cards left in the deck to draw from. |
| Witchatter, The Mad | On Escape: The enemy creature goes mad and damages its Empire by its base strength and level. |
| S | S: When one of your Vampires wins a duel, add another random Vampire to your hand. If a Vampire fighting for your Empire ever loses, discard all your Vampires. Any that enter your hand are immediately discarded. |
| S | If all creatures in your hand are Large (base strength 5 or higher), give your creatures `+1 level`. |
...
| S | Turn all your opponent's creatures into `Nightmares`. Then, give them `-2 levels`. |
| Prometheus' Witch | _The Gift of Fire_: Your Empire takes 1 damage per turn, but your `Fire` creatures have a permanent `+2 power`. Steal a `Fire` card from your opponent, if present. |
| S | _Blood Magick_: You pay 6 HP to cast the effect of one of the last 5 Witches to enter the Graveyard. |
| Antonio's Witch | _Forced Conversion_: Halve the levels (rounded down) of all cards in your opponent's hand. Those levels are randomly distributed amongst your hand. He keeps the other half with a cost: His creatures are forced to convert to `Holy`. |
| Witchlock | _The Legal Loophole_: The next time your opponent wins a duel, they spill blood. Their Empire takes damage equal to their creature's level. |
| Witchlock | _Merry Bond_: Your opponent draws 2 cards. You get to see them. Each turn either card remains in hand, your Empire gains +2 HP. |
| Witchlock | _A Pound of Flesh_: Choose a creature or Witch to give your opponent. Each turn (except this one) it's not played, your Empire gains +2 HP. When that card is played, your opponent takes 6 damage. If the majority of cards in their hand are `Holy`, you take 6 damage instead. |
| Sophie's Witch | _Hurt by Guilt_: Your opponent must choose a creature in their hand to be Exterminated (removed from the game). For the rest of the game, they are haunted: Whenever anyone plays a creature of that same Tribe, the opponent takes damage equal to the Exterminated creature's level. |
| Sophie's Witch | Look at the two most powerful creatures in your hand. Choose one to survive and give it `+6 levels`. The other is discarded immediately. The surviving creature permanently has its base strength reduced to 0—it is hollowed by guilt. |
...
| Choir Witch | S: While you control all 4 Power Types, your cards duel with `+3 power`. |
| S | Discard all `Holy` creatures from your hand. Gain +3 HP for each that ascends. |
| Wichita Witch | Shuffle both hands into the deck. Each player draws one card per unique Tribe they previously held. |
| Regal Witch | If this witch dies, it leaves its golden jewelry behind. For the rest of the game, when one of your Pirates loses a duel, add another random Pirate to your hand. |
| Herculean Witch | Choose a creature in your hand to bless with `+6 levels`. When it wins a duel, it reenters your hand with `-1 level`. If it wins 3 duels, it ascends to be with the gods and heals your Empire for its base strength. If it ever loses a duel, it deals double damage to your Empire and is destroyed. |
| Heretic Witch | _Blasphemy_: Reveal any `Holy` creatures in your opponent's hand. Choose one to be imprisoned (Paralyzed). |
| Lexical Witch | _Semantic Shift_: Choose to swap the meaning of a pair of words for the next 2 turns: draw/discard or heal/damage. |
| Pork Witch | _Swine Fever_: Turn the opponent's strongest creature into a __Pig__ (base strength 1, no Power Type). If the Pig is defeated, you gain 5 HP. |
| Ticking Witch | This witch cycles its level from 1-6. When played, an enemy creature with the same level goes berserk, damaging the enemy Empire and gaining cooldown 2. |
| Bouquet Witch | Discard 3 random creatures and heal 2 HP for each Tribe lost. Then draw 3 new cards. |
| Witch McConnell | Choose a Power Type. Cards of that type cannot be played by either player for 3 turns. <br>"The Senate will not be moved." |
| Thousand-Yard Witch | _Shell-Shock_: If this witch survives its duel, the enemy creature is returned to their hand Frozen. That card "loses its mind": its Power Type is removed and it cannot be used in Rallies for the rest of the game. |
| Blitzkrieg Witch | The next creature played by your opponent is swapped with another creature in their hand before the duel. If they have no other creature, you damage them directly. |
| Witchstorm Thurmond | While in hand, neither player can draw any cards or gain HP. At the start of each turn, your opponent may choose to discard half their hand (rounded up) to destroy Witchstorm Thurmond. |
| Bo Weevah Witch | For the rest of the game, neither Empire may gain HP. |
...
| S | Destroy the top 10 cards of the deck. For each Witch discarded this way, your opponent takes 3 damage. For each creature, you take 1 damage. |
| Outlaw Witch | _Dead or Alive_: Turn a random creature in your opponent's hand into a Fugitive. It cannot be used in Rallies, and can only be played if there are no other creatures in their hand. If the Fugitive is ever discarded, the enemy takes double its base strength. |
| Trench Witch | _War of Attrition_: Cards in both hands lose `1 level` at the end of every turn (cannot be reduced below 1). |
| No Man's Witch | _The Dead Zone_: Shuffle the Graveyard and add it back to the top of the deck. |
...
| S | Add 3 Stopwatches to your hand. When played, give your opponent's hand `+1 cooldown`. You will be helpess to attacks. |
...
| Leaning Witch | Choose a Power Type. Creatures in both hands matching it gain `+2 levels`; opposites lose `1 level`. |
...
| Quiet Gazing Witch | Instead of drawing each turn, you see the top 3 cards of the deck and choose one to keep. |
...
| Superstitious Witch | Pick a number (1-6). For the rest of the game, whenever a card enters play at that level, its owner takes 2 damage. |
...
| Scurvy Witch | _ALL_ Pirates lose `3 levels` wherever they are. |
...
| Reniassance Witch | Look at 6 Greek/Roman cards. Choose one to keep. |
...
| Farmer Witch | Add 3 __Chickens__ (Jersey Giant, White Leghorn, Orpington) to your hand. If all 3 are lost (outside your hand), your Empire takes 24 damage. |
...
| S | Cards in both hands gain cooldown 1. Your cards gain `+1 level` per cooldown they have. |
| S | For the next 3 turns, cards played have their base strengths doubled. |
| S | Choose a card in your hand. Swap it with a random card in your opponent's. |
| S | _Twist Desires_: Change a creature's Power Type to its current disadvantage. |
| Torch Witch | Discard a `Fire` card. For the rest of the game, your Empire duels with `+2 power` against `Nightmare` types. |
| S | `Holy` creatures lose favor from the gods. For the rest of the game, the `Ancients` have a `+4 power` type advantage over `Holy` creatures. |
| Alcestis' Witch | Whenever you lose a duel, if you're holding a weaker creature from the same Tribe played, swap them before taking damage. |
| S | Your Rallied creatures match the level of the greatest Rally member. |
| S | Creatures you play have their level set to your highest level `Holy` card in hand. |
| S | Restore 16 HP to your Empire, but you will always lose in Mayhem. |
| Lich Witch | _Cheat Death_: Choose a `Nightmare` creature in your hand to grant Immortality. Instead of going to the Graveyard, it returns to your hand. Give your opponent a __Soul Jar__ that takes away your creature's Immortality when played. If played against the creature, kill it instantly. |
| Adam's Witch | _Tree of Knowledge_: Add a __Lvl.1 Forbidden Fruit__ to your hand. If discarded or played, convert all your creatures to `Nightmare` types, and buff them by the level of the Forbidden Fruit. |
| Eve's Witch | _Fall From Grace_: Give your opponent a __Lvl.1 Forbidden Pomegranate__. When played, discarded, or when you win a duel with a Serpent, the enemy Empire eats the fruit: "Your Empire takes damage from a creature's base strength _AND_ level." |
| Noah's Witch | Two creatures from every Tribe left in the deck are paired together (adjacently). All other creatures and Witches in the deck are destroyed. |
| S | Choose to sort the deck in ascending or descending order of strength. |
| S | Add a __Lvl.1 Decoy {0}__ to your hand. |
| Atra Mor's Witch | Shuffle 6 __Plague Rats__ into the deck. When drawn, the player's hand loses `2 levels`. Plague Rats deal 2 damage to the holding Empire at the end of each turn. |
| Eris' Witch | _For the Fairest_: Cards from both Empires brawl. Only the top 5 highest-level cards survive. |
| St. George's Witch | _The Dragonslayer_: If dueling a Dragon, auto-win and deal double damage. Otherwise, duel with `+3 power` against cards with base strength 5 or higher. |
...
| Jolie Rouge Witch | _No Quarter_: Both players discard their highest level creature. The winner of the next duel earns theirs back. giving their hand `+1 level`. |
| Joseph Druce's Witch | _The Priest and The Hitchhiker_: Target the strongest `Holy` creature in your opponent's hand and strangle it with a sock. The enemy Empire is damaged by its base strength and the creature is destroyed. <br>"Your days are over. No more children for you, pal." |
| Smiledge's Hate Witch | _Lifelong Phobia_: `Holy` cards evaporate in your hand, but your `Nightmares` duel with `+4 power`. |
| Dime-Dropper's Witch | _Witness Immunity_: Freeze a random card in your opponent's hand. Add an Emancipating Witch to yours. |
| Brace's Cove Witch | Paralyze a card in your opponent's hand, then abduct it. If that card ever leaves your hand, your Empire takes 12 damage. <br>"One touch too far…now you're mine forever." |
| Dark Harvest Witch | "Each soul reaped ripens my wrath." <br>Give your hand `+1 level` per card discarded this game. |
| Dead Man's Witch | If your opponent is holding 2 Skeletons and 2 Pirates, deal 8 damage to them. Deal an additional 4 damage for each of those cards that are `Nightmare`. |
...
| Aegis Witch | Obtain the __Aegis__. While in hand, the Aegis grants you `+3 power` when dueling against creatures or Witches with less base strength than your own. Playing the Aegis will Paralyze the enemy card before battle. |
...
| Surtr's Witch | _Sons of Muspelheim_: Add 2 random `Fire` Giants to your hand, then give your `Fire` creatures `+3 levels`. |
...
| Jormungandr's Witch |
| Kraken Crone |
| Hyrrokkin's Witch | If you're holding a Giant, Wolf and Serpent, deal 7 damage to the enemy Empire. |
| Witch Luminarias |
| Wiccan Le Fay |
...
| S | _W_: Your `Ancient` creatures are twice as effective (+6 power) against `Fire` types. |
...
| Apocalyptic Witch | Shuffle the Four Horsemen into the deck. Once each one is played, end the game. |
| Baden's Witch | The next time you are about to lose a duel, switch the card played with the most powerful creature in hand and fight again. |
| Xartrath's Witch | 
...
| S | If you're holding a `Fire` Dragon, deal its level as damage to the enemy Empire. |
| S | If you're holding a `Holy` Dragon, restore HP to your Empire equal to its level. |
| S | If you're holding an `Ancient` Dragon, add two more `Ancient` Dragons to your hand. |
| S | If you're holding a `Nightmare` Dragon, it eats two cards in your opponent's hand and absorbs their levels. |
...
- __On Entry__ — When a card first enters your hand.
- __While in hand__ — A continuous effect active as long as the card remains in hand.
- __At the start of your turn__ — Resolves after drawing a card, before dueling.
...
- When cards are __Shuffled__ into the deck, the deck order is randomized.
...
- __Graveyard__ — The pile of used cards:  
	Creatures that win/lose a duel, and Witches or other cards played or discarded.

- __Witch Order__: At the start of the game, a player is chosen to go first.

	- They will draw first on odd-numbered turns. The opponent on even turns.  
	- The player who drew first will have their Witch's effect resolve first.

- __Fail To Case__: Witches that require certain cards in your hand (or your opponent's) will "fail to cast."  
	This will be communicated to both players.

	- __Ex.__ If a Witch discards a creature to heal your Empire for its level, but you hold no creatures, then nothing happens. The Witch is played as an ordinary Witch.
...
Creatures that have an effect attached to them:

	Lvl.5 Ancient Giant [?] {5}
